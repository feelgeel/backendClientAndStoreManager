...
const  StoreManualOrderSchema = new mongoose.Schema({
...
const  store_manual_order_list = mongoose.model('store_manual_order_list', StoreManualOrderSchema);
...
exports.store_manual_order_list=store_manual_order_list;
