...
ManifactureOwnerSchema = new mongoose.Schema({
    timestamp:Number,
    userId:String,
    manifatureId:String,
});
const  ManifactureOwner = mongoose.model('ManifactureOwner', ManifactureOwnerSchema);
...
exports.ManifactureOwner=ManifactureOwner;
